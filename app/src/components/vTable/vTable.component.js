 ...
 */
const VTable = ({ tableStructure,tableSeachCallback,tableOrderCallback, bodyHeight, rowComponent, rowsSize, rowsCount }) => {
                    ...
                    <tr>
                        {
                            tableStructure.map(tableEntry => {
                                return <td onClick={tableOrderCallback} tableIndex={tableEntry.dataIndex} style={{position:"relative"}}>
                                    {tableEntry.columnName}

                                    {
                                    (tableEntry.orderable) ?
                                      <i className={"fas fa-sort-"+(tableEntry.ord)} style={{position:"absolute",top:"45%",right:5}}></i>
                                      :
                                      <div></div>
                                    }
                                  </td>
